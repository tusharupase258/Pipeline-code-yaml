This YAML pipeline includes a manual validation step between the Terraform planning and applying stages. Below, Lets breakdown the entire process and the key components of the pipeline.
